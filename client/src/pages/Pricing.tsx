...
const plans = [
  {
    ...
    features: ["5-Page Responsive Website", "Mobile-First Design", "Contact Form Integration", "Basic SEO Setup", "SSL Certificate", "1 Month Free Support", "Google Analytics Setup"],
    excluded: ["Custom Functionality", "E-commerce Store", "Priority Support"],
    popular: false,
  },
  {
    name: "Business",
    ...
    features: ["10-Page Custom Website", "Premium Design System", "Advanced SEO Package", "Content Management System", "E-commerce Ready (Up to 50 products)", "3 Months Free Support", "Analytics Dashboard", "Performance Optimization", "Social Media Integration"],
    excluded: ["Unlimited Products"],
    popular: true,
  },
  {
    name: "Professional",
    ...
    features: ["Unlimited Pages", "Custom Functionality", "Full E-commerce Store", "Payment Gateway Integration", "Priority Support (6 months)", "Complete SEO Package", "Training Sessions", "Monthly Performance Reports", "Content Strategy"],
    excluded: [],
    popular: false,
  },
  {
    ...
    features: ["Unlimited Everything", "Custom Web Applications", "Enterprise Security", "Dedicated Account Manager", "24/7 Priority Support", "Custom Integrations", "Training & Onboarding", "SLA Guarantee", "Scalability Planning", "White-label Solutions"],
    excluded: [],
    popular: false,
  },
];
