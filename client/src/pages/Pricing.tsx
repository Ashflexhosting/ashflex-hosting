...
const plans = [
  ...
  },
  {
    ...
    features: ["Unlimited Pages", "Custom Functionality", "Full E-commerce Store", "Payment Gateway Integration", "API Integrations", "Priority Support (6 months)", "Complete SEO Package", "Training Sessions", "Monthly Performance Reports", "Content Strategy"],
    excluded: [],
    popular: false,
  },
  {
