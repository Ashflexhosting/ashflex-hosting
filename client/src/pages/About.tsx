...
const team = [
  { name: "Uzodimma Ogbonnaya", role: "Founder & CEO", bio: "8+ years leading digital innovation across Africa and beyond.", img: "/manus-storage/team-ceo_103bb175.png", accent: "from-brand-accent to-[#B2002F]", featured: true },
...
const trustPoints = [
  "Proven track record with 242+ successful projects",
  "Award-winning design team with 8+ years experience",
            ...
            <div className="lg:col-span-6">
              ...
              <div className="mt-8 space-y-5">
                ...
                <p className="scroll-reveal text-base md:text-lg text-white/60 leading-relaxed" style={{ transitionDelay: "220ms" }}>
                  Over the past decade, we've helped more than 242 businesses establish their digital presence — from startups to enterprises, from local shops to international brands — earning a 89% satisfaction rate along the way.
                </p>
              ...
              >
                ...
                <div className="relative rounded-[1.75rem] overflow-hidden border border-white/10 shadow-2xl shadow-black/40">
                  ...
                  <div className="absolute bottom-5 left-6 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-bold text-sm" style={{ fontFamily: "var(--font-heading)" }}>8+ Years of Digital Craft</p>
                ...
                >
                  <p className="text-2xl font-extrabold bg-gradient-to-r from-brand-accent to-brand-secondary bg-clip-text text-transparent leading-none" style={{ fontFamily: "var(--font-heading)" }}>89%</p>
      ...
      <section className="py-20 md:py-24 bg-[#0A1640] relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12">
            <CounterStat value={242} suffix="+" label="Projects Delivered" />
            <CounterStat value={89} suffix="%" label="Client Satisfaction" delay="100ms" />
            <CounterStat value={8} suffix="+" label="Years Experience" delay="200ms" />
            <CounterStat value={13} suffix="+" label="Countries Served" delay="300ms" />
          </div>
        </div>
      </section>
