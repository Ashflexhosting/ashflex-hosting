            ...
            <div key={`${brand.name}-${i}`} className="inline-flex items-center shrink-0 whitespace-nowrap px-7 md:px-9 group-hover:[animation-play-state:paused]" style={{ pointerEvents: "auto" }}>
              ...
              >
                <img
                  ...
                  alt={brand.name}
                  loading="lazy"
                  className="h-16 md:h-20 w-auto max-w-[230px] md:max-w-[270px] object-contain grayscale transition-all duration-300 hover:grayscale-0 hover:scale-[1.12] hover:drop-shadow-[0_18px_32px_rgba(7,27,90,0.38)]"
                />
              </a>
            </div>
          ))}
