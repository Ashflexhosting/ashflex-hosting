            ...
            <div className="lg:col-span-5 scroll-reveal-left">
              <div className="relative max-w-sm mx-auto lg:max-w-none">
                ...
                >
                  ...
                  <span className="text-sm font-extrabold text-[#1B2A6B] leading-tight">240+<br />Projects Delivered</span>
                </div>
                <div
                ...
                >
                  ...
                  <span className="text-sm font-extrabold text-[#1B2A6B] leading-tight">87%<br />Client Satisfaction</span>
                </div>
