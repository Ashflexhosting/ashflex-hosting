export const faqs = [
  {
    ...
    answer: "Website costs vary based on complexity, features, and scope. Our Starter packages begin at ₦150,000, while Enterprise solutions can range from ₦1,000,000+. We provide a free consultation to understand your needs and give an accurate quote.",
  },
  {
    question: "How long does it take to build a website?",
    answer: "Timeline depends on the project scope. A simple website typically takes 2-4 weeks, while complex custom solutions may take 6-12 weeks. We provide detailed timelines during the planning phase.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, we offer reliable hosting solutions with 99.9% uptime guarantee, SSL certificates, daily backups, and CDN. Hosting packages start from ₦15,000/year.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes! We offer AI-powered solutions including chatbots, workflow automation, AI content generation, predictive analytics, and custom AI integrations to streamline your business operations.",
  },
  {
