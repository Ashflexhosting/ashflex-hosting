...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    category: "Corporate",
    overview: "A showcase website for a Nigerian film and media production company with new titles and trailers.",
  ...
  },
  {
    ...
    category: "Interiors",
    overview: "A portfolio site presenting a residential and commercial interior-design practice.",
  ...
  },
  {
    ...
    category: "Finance",
    overview: "A clear web presence for a Canadian personal auto-financing scheme with an easy application path.",
  ...
  },
  {
    ...
    category: "Education",
    overview: "A dedicated website presenting flight-training programmes for aviation professionals.",
  ...
  },
  {
    ...
    category: "NGOs",
    overview: "An advocacy-focused website for a US non-profit empowering vulnerable communities in Africa.",
  ...
  },
  {
    ...
    title: "Sam & Sara",
    category: "E-commerce",
    overview: "A corporate site for a Nigerian clothing and uniform-manufacturing factory serving organisations.",
  ...
  },
  {
    ...
    category: "Travel",
    overview: "A travel and study-abroad services website with clear package offerings and booking pathways.",
  ...
  },
  {
    ...
    category: "Corporate",
    overview: "A focused one-page corporate site for strategic support and consultancy services.",
  ...
  },
  {
    ...
    category: "Finance",
    overview: "A full dealership website with browsable inventory, trade-in pathways, and a buyer-trust story.",
    image: "/manus-storage/bcfna-fullpage-hd_6551ddb7.webp",
  ...
  },
  {
    ...
    category: "NGOs",
    overview: "A member-facing cooperative savings platform with dashboards, savings tracking, and FAQs.",
  ...
  },
  {
    ...
    category: "Corporate",
    overview: "A multi-page corporate site for a Lagos construction firm with 30+ years of engineering experience.",
  ...
  {
    id: 13,
    title: "Karossy Travels & Tours",
    category: "Travel",
    overview: "A complete flight, hotel, visa, and pilgrimage booking platform for a leading Nigerian travel agency.",
    image: "/manus-storage/karossy-home_570df773.png",
    challenge: "Karossy Travels & Tours Limited, a Lagos-based travel agency, needed a booking-focused website showcasing affordable flights, visas, pilgrimages, and tour packages.",
    solution: "Ashflex built a travel booking platform covering flight reservations, hotels, holidays, charter, pilgrimage journeys, visa assistance, and car rentals, with branches across Lagos, Uyo, and London.",
    technologies: ["Website Design", "Travel Booking"],
    results: publicMetricsNote,
    client: "Karossy Travels & Tours Limited",
    website: "https://karossytravels.com/",
    screenshots: [
      "/manus-storage/karossy-home_570df773.png",
      "/manus-storage/karossy-about_0d74eddf.png",
      "/manus-storage/karossy-pilgrimage_442c916d.png",
    ],
    screenshotCaptions: ["Homepage", "About Us page", "Pilgrimage Journeys page"],
  },
  {
    id: 14,
    ...
    image: "/manus-storage/chi-zaram-home_d868e84f.png",
    ...
    screenshots: [
      "/manus-storage/chi-zaram-home_d868e84f.png",
      "/manus-storage/chi-zaram-story-values_a3ca1d34.png",
      "/manus-storage/chi-zaram-catalogue_1f4e0682.png",
    ],
  ...
  },
  {
    ...
    overview: "A hospitality website for a luxury hotel, suites, and events centre in Umuahia.",
